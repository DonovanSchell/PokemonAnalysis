...
*Note: The lower the Base Catch Rate, the higher the catch difficulty*
...
*Catch rate probability calculations based on formulas found on [Bulbapedia](https://bulbapedia.bulbagarden.net/wiki/Catch_rate)*
